...
- 首轮命中后立即出现 DUMBER 自研的青、蓝、紫、粉、黄整圈虹彩边框；3.6 秒完成一轮高饱和色彩变幻，并带有轻量边缘辉光；
...
```text
dist/dumber-0.3.13.zip
dist/dumber-0.3.13.zip.sha256
dist/dumber-0.3.13-source.zip
dist/dumber-0.3.13-source.zip.sha256
```
